...
public class RestTransporte {
    ...
    public ResponseEntity<List<Transporte>> getTransportesPorUsuario(@PathVariable Integer usuario) {
        List<Transporte> transporte = transporteService.getTransportesPorUsuario(usuario);
